"""
Fee Extremes V2 — Bayesian signal + relaxed timing + cross-asset + FADE mode.
...
class FeeExtremesV2Strategy(BaseStrategy):
    """
    ...
    name = "fee_extremes_v2"

    def __init__(self, config: FeeExtremesV2Config = None):
        self.config = config or FeeExtremesV2Config()
